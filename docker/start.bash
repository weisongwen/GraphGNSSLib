...
then
	...
	docker run -it   -v /tmp/.X11-unix:/tmp/.X11-unix -v $SHARED_HOST_DIR:$SHARED_DOCKER_DIR  -e DISPLAY=unix$DISPLAY -e GDK_SCALE -e GDK_DPI_SCALE -e ROS_MASTER_URI=http://172.17.0.2:8899 -e ROS_HOSTNAME=172.17.0.2 --name graph1 ros:GraphGNSSLib /bin/bash 
